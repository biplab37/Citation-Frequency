...
export default function SearchArea() {
    ...
    return (
        <div className="w-sm p-4 md:w-2xl lg:w-4xl mx-auto mt-10 flex flex-col items-center">
        <div className="w-2xs md:w-lg lg:w-xl flex md:flex-row flex-col items-center justify-center gap-6">
        ...
        <div>
            {!loading && data.length>0 && <ChartArea keyword={keyword} data={data}/>}
        </div>
        </div>
    )
}